...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        //todo: koppeling leggen met roles

//        //todo hij maakt dus een userDetails aan met oa roles en voegt 'ie een user toe, ik wil dat al bijhouden in lijst authorities, moet ik het dan nog een keer doen?
//        //todo wat wordt er met deze roles gedaan?
        ...
        UserDetails userDetails =
                org.springframework.security.core.userdetails.User.builder()
                        ...
                        //hier zou ik ze uit de database moeten halen?
                        ...
                        //.roles(user.getRoles())
                        .roles(new String[]{"USER"}) // todo: aanpassen naar mijn rolnamen
                        .build();
        return userDetails;
    }
